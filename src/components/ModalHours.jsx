...
const Fade = React.forwardRef(function Fade(props, ref) {
  ...
  export default function SpringModalHour() {
    ...
    return (
      <div>
        <button onClick={handleOpen} type="button" className="button">
                <span className="button__text">Add hour</span>
        ...
        >
          <Fade in={open}>
            <Box sx={style}>
              ...
              <BasicSelect/>
              <br />
              <Button variant="contained">Add hour</Button>
              </Typography>
            </Box>
          </Fade>
        </Modal>
